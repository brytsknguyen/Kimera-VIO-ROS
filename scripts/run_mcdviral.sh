...
ROS_PKG=kimera_vio_ros

source /home/$USER/kimera_ws/devel/setup.bash
...
EPOC_DIR=/media/$USER/mySataSSD2/DATASETS/MCDVIRAL/Experiment/kimera_vio_noloop
...
# EPOC_DIR=/media/$USER/mySataSSD2/DATASETS/MCDVIRAL/Experiment/SLICT/kimera_vio_loope
